...
def build_forecast_sync() -> dict:
    ...
    try:
        ...
        _cache_set(_forecast_cache_key, json.dumps(result, default=str), 3600)   # 1h — matches scheduler
...
async def lifespan(app: FastAPI):
    ...
    scheduler.add_job(build_forecast_sync, "interval", hours=1, id="forecast_refresh",
